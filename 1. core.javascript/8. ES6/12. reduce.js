...
// accumalator: 어떤 데이터를 쌓아가는 변수
// currentValue: 현재 루프 회차에서 사용할 데이터
// reduce는 반복을 실행할때마다 currentValue를 accumalator에 누적함
...
// reduce의 콜백함수 다음 파라미터는 initialValue를 의미하며 반복문의 accumalator시작값을 의미함 
// 따라서 0을 시작값으로 두고 return a + b;를 하면 
// 0 +..~6
// 시작값을 없애면 accumalator의 시작값이 0번 인덱스로 지정되며
// 1 +..~6
